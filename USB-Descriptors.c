 ...
 *  Descriptor.
 */
// Manufacturer string set at "www.obdev.at" for compatibility with DG8SAQ code
USB_Descriptor_String_t PROGMEM ManufacturerString =
{
	.Header                 = {.Size = USB_STRING_LEN(12), .Type = DTYPE_String},
		
	.UnicodeString          = L"www.obdev.at"
};
...
USB_Descriptor_String_t PROGMEM ProductString =
{
	...
	.UnicodeString          = L"DG8SAQ-I2C"
};


/** Serialnumber descriptor string. This is a Unicode string containing the product's serialnumber in human readable form,
 *  and is read out upon request by the host when the appropriate string ID is requested, listed in the Device
 *  Descriptor.
 */
