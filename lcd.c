/****************************************************************************
 ...
 Minor nitpick type fixes by Loftur E. Jonasson, 2009-07-04 & 2009-08-22
		Note that these LCD display routines appear to be very lean on
		pgmspace usage, compared with the avrlib lcd.c/h, which,
		when tested with the Mobo project, compiled to a 1.1 kB larger code
...
/*************************************************************************
A lean version of lcd_puts, no end of line checks, etc...

Loftur E. Jonasson, TF3LJ
*************************************************************************/
void lcd_puts_lean(const char *s)
/* print string on lcd (no auto linefeed) */
{
    register unsigned c;
...
// LJ added #if LCD_CONTROLLER_KS0073
#if LCD_CONTROLLER_KS0073
