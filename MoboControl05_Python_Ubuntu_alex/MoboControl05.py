...
#
# Version 0.5, 2010-04-18, Loftur Jónasson TF3LJ
#
...
class Launcher(model.Background):
    ...
    def on_btnI2CButton_command(self,event):
        ...
        try:
            ...
            time.sleep(6)   # Wait for Mobo uC to reset itself
    ...
    def powerMeter(self, event):
		...
		canvas.drawText(str(num[j]),(i*step/4-3, 6))
                j = j + 1
            else:
    ...
    def swrMeter(self, event):
        ...
        for i in range(1, 16, 1):
                ...
                canvas.drawText(scale[j+1],(i*step - 7, 6))
