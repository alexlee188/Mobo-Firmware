...
#----------------------------------------------------------------------------
# This makefile has been adapted to the Mobo Firmware Project
# last modification: 2010-04-13 Loftur E. Jonasson, TF3LJ
#----------------------------------------------------------------------------
...
SRC = USB-EP0.c													  \
	  ...
	  lcd_i2c.c													  \
	  avrlib/rprintf.c											  \
	  pe0fko_DeviceSi570.c										  \
	  pe0fko_CalcVFO.c											  \
	  pe0fko_I2Copencollector.c									  \
	  Mobo_ShaftEncoder.c										  \
	  Mobo_I2C_Peripherals.c									  \
	  Mobo_LCD_Display.c										  \
	  Mobo_ABPF.c											      \
	  Mobo_Pwr_SWR_and_Bias_cal.c								  \
	  Mobo_LCD_bargraph_lowlevel.c								  \
